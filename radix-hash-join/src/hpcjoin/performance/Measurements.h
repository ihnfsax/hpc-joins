...
public:
  ...
  static void
  stopHistogramLocalHistogramComputation(uint64_t numberOfElemenets);
...
public:
  ...
  static void
  stopNetworkPartitioningMainPartitioning(uint64_t numberOfElemenets);
...
public:
  ...
  static void
  stopLocalPartitioningHistogramComputation(uint64_t numberOfElemenets);
