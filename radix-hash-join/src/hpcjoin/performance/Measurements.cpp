...
struct timeval
    hpcjoin::performance::Measurements::waitingForNetworkCompletionStart;
struct timeval
    hpcjoin::performance::Measurements::waitingForNetworkCompletionStop;
struct timeval
    hpcjoin::performance::Measurements::localProcessingPreparationsStart;
struct timeval
    hpcjoin::performance::Measurements::localProcessingPreparationsStop;

struct timeval
    hpcjoin::performance::Measurements::histogramLocalHistogramComputationStart;
struct timeval
    hpcjoin::performance::Measurements::histogramLocalHistogramComputationStop;
struct timeval hpcjoin::performance::Measurements::
    histogramGlobalHistogramComputationStart;
struct timeval
    hpcjoin::performance::Measurements::histogramGlobalHistogramComputationStop;
...
struct timeval
    hpcjoin::performance::Measurements::histogramOffsetComputationStart;
struct timeval
    hpcjoin::performance::Measurements::histogramOffsetComputationStop;

struct timeval hpcjoin::performance::Measurements::
    networkPartitioningMemoryAllocationStart;
struct timeval
    hpcjoin::performance::Measurements::networkPartitioningMemoryAllocationStop;
struct timeval hpcjoin::performance::Measurements::
    networkPartitioningMainPartitioningStart;
struct timeval
    hpcjoin::performance::Measurements::networkPartitioningMainPartitioningStop;
struct timeval hpcjoin::performance::Measurements::
    networkPartitioningFlushPartitioningStart;
struct timeval hpcjoin::performance::Measurements::
    networkPartitioningFlushPartitioningStop;
struct timeval
    hpcjoin::performance::Measurements::networkPartitioningWindowPutStart;
struct timeval
    hpcjoin::performance::Measurements::networkPartitioningWindowPutStop;
struct timeval
    hpcjoin::performance::Measurements::networkPartitioningWindowWaitStart;
struct timeval
    hpcjoin::performance::Measurements::networkPartitioningWindowWaitStop;
...
struct timeval hpcjoin::performance::Measurements::
    localPartitioningHistogramComputationStop;
struct timeval
    hpcjoin::performance::Measurements::localPartitioningOffsetComputationStart;
struct timeval
    hpcjoin::performance::Measurements::localPartitioningOffsetComputationStop;
struct timeval
    hpcjoin::performance::Measurements::localPartitioningMemoryAllocationStart;
struct timeval
    hpcjoin::performance::Measurements::localPartitioningMemoryAllocationStop;
struct timeval
    hpcjoin::performance::Measurements::localPartitioningPartitioningStart;
struct timeval
    hpcjoin::performance::Measurements::localPartitioningPartitioningStop;
...
struct timeval
    hpcjoin::performance::Measurements::buildProbeMemoryAllocationStart;
struct timeval
    hpcjoin::performance::Measurements::buildProbeMemoryAllocationStop;
...
void Measurements::startJoin() {
  ...
  if ((ret = PAPI_library_init(PAPI_VER_CURRENT)) != PAPI_OK) {
    ERROR_RETURN(ret);
  } else if ((ret = PAPI_create_eventset(&eventSet)) != PAPI_OK) {
    ERROR_RETURN(ret);
  } else if ((ret = PAPI_add_event(eventSet, PAPI_TOT_CYC)) != PAPI_OK) {
    ERROR_RETURN(ret);
  } else if ((ret = PAPI_start(eventSet)) != PAPI_OK) {
    ERROR_RETURN(ret);
  }
}
...
void Measurements::stopJoin() {
  ...
  long_long value;
  int ret = 0;
  if ((ret = PAPI_stop(eventSet, &value)) != PAPI_OK) {
    value = 0;
  }
...
void Measurements::stopWaitingForNetworkCompletion() {
  ...
  specialTimes[1] = timeDiff(waitingForNetworkCompletionStop,
                             waitingForNetworkCompletionStart);
}
...
void Measurements::stopLocalProcessingPreparations() {
  ...
  specialTimes[2] = timeDiff(localProcessingPreparationsStop,
                             localProcessingPreparationsStart);
}
...
void Measurements::stopHistogramLocalHistogramComputation(
    uint64_t numberOfElemenets) {
  ...
  JOIN_ASSERT(histogramLocalHistogramComputationIdx < 2, "Performance",
              "Index out of bounds");
  histogramLocalHistogramComputationTimes
      [histogramLocalHistogramComputationIdx] = time;
  histogramLocalHistogramComputationElements
      [histogramLocalHistogramComputationIdx] = numberOfElemenets;
...
void Measurements::stopHistogramGlobalHistogramComputation() {
  ...
  JOIN_ASSERT(histogramGlobalHistogramComputationIdx < 2, "Performance",
              "Index out of bounds");
  histogramGlobalHistogramComputationTimes
      [histogramGlobalHistogramComputationIdx] = time;
...
void Measurements::stopHistogramAssignmentComputation() {
  ...
  histogramAssignmentComputationTime =
      timeDiff(histogramAssignmentStop, histogramAssignmentStop);
}
...
void Measurements::stopHistogramOffsetComputation() {
  ...
  uint64_t time =
      timeDiff(histogramOffsetComputationStop, histogramOffsetComputationStart);

  JOIN_ASSERT(histogramOffsetComputationIdx < 2, "Performance",
              "Index out of bounds");
...
void Measurements::stopNetworkPartitioningMemoryAllocation(
    uint64_t numberOfElemenets) {
  gettimeofday(&networkPartitioningMemoryAllocationStop, NULL);
  uint64_t time = timeDiff(networkPartitioningMemoryAllocationStop,
                           networkPartitioningMemoryAllocationStart);

  JOIN_ASSERT(networkPartitioningMemoryAllocationIdx < 2, "Performance",
              "Index out of bounds");
  networkPartitioningMemoryAllocationTimes
      [networkPartitioningMemoryAllocationIdx] = time;
...
void Measurements::stopNetworkPartitioningMainPartitioning(
  ...
  JOIN_ASSERT(networkPartitioningMainPartitioningIdx < 2, "Performance",
              "Index out of bounds");
  networkPartitioningMainPartitioningTimes
      [networkPartitioningMainPartitioningIdx] = time;
...
void Measurements::stopNetworkPartitioningFlushPartitioning() {
  ...
  JOIN_ASSERT(networkPartitioningFlushPartitioningIdx < 2, "Performance",
              "Index out of bounds");
  networkPartitioningFlushPartitioningTimes
      [networkPartitioningFlushPartitioningIdx] = time;
...
void Measurements::stopNetworkPartitioningWindowPut() {
  ...
  uint64_t time = timeDiff(networkPartitioningWindowPutStop,
                           networkPartitioningWindowPutStart);
...
void Measurements::stopNetworkPartitioningWindowWait() {
  ...
  uint64_t time = timeDiff(networkPartitioningWindowWaitStop,
                           networkPartitioningWindowWaitStart);
...
void Measurements::stopLocalPartitioningTask() {
  ...
  uint64_t time =
      timeDiff(localPartitioningTaskStop, localPartitioningTaskStart);
...
void Measurements::stopLocalPartitioningHistogramComputation(
    uint64_t numberOfElemenets) {
...
void Measurements::stopLocalPartitioningPartitioning(
    uint64_t numberOfElemenets) {
  gettimeofday(&localPartitioningPartitioningStop, NULL);
  uint64_t time = timeDiff(localPartitioningPartitioningStop,
                           localPartitioningPartitioningStart);
...
void Measurements::stopBuildProbeMemoryAllocation(uint64_t bufferSize) {
  ...
  uint64_t time =
      timeDiff(buildProbeMemoryAllocationStop, buildProbeMemoryAllocationStart);
...
uint64_t *Measurements::serializeResults() {
  ...
  uint64_t *result =
      (uint64_t *)calloc(NUM_OF_RESULT_ELEMENTS, sizeof(uint64_t));
...
void Measurements::sendMeasurementsToAggregator() {
  ...
  MPI_Send(results, resultSize, MPI_BYTE,
           hpcjoin::core::Configuration::RESULT_AGGREGATION_NODE,
           MSG_TAG_RESULTS, MPI_COMM_WORLD);
}

void Measurements::receiveAllMeasurments(uint32_t numberOfNodes,
                                         uint32_t nodeId) {
...
void Measurements::printMeasurements(uint32_t numberOfNodes, uint32_t nodeId) {
  ...
  JOIN_ASSERT(nodeId == hpcjoin::core::Configuration::RESULT_AGGREGATION_NODE,
              "Measurements", "Only coordinator should print results");
  ...
  printf(
      "[RESULTS] Summary:\t%lu\t%.3f\t%.3f\t%.3f\t%.3f\n", totalNumberOfTuples,
...
void Measurements::init(uint32_t nodeId, uint32_t numberOfNodes,
                        std::string tag) {
  ...
  if (nodeId == hpcjoin::core::Configuration::RESULT_AGGREGATION_NODE) {
    ...
    sprintf(experimentFullPath, "%s/%s-%d-%lu", cwdPath, tag.c_str(),
            numberOfNodes, experimentId);
    mkdir(experimentFullPath, S_IRUSR | S_IWUSR | S_IXUSR);
  }

  MPI_Bcast(&experimentId, 1, MPI_UINT64_T,
            hpcjoin::core::Configuration::RESULT_AGGREGATION_NODE,
            MPI_COMM_WORLD);

  sprintf(performanceFullPath, "%s/%s-%d-%lu/%d.perf", cwdPath, tag.c_str(),
          numberOfNodes, experimentId, nodeId);
  performanceOutputFile = fopen(performanceFullPath, "w");

  sprintf(metaDataFullPath, "%s/%s-%d-%lu/%d.info", cwdPath, tag.c_str(),
          numberOfNodes, experimentId, nodeId);
...
// 	int eventCodes[PAPI_COUNT] = { PAPI_L1_TCM, PAPI_L1_DCM };
//     int eventSet = PAPI_NULL;
...
//     } else if ((ret=PAPI_create_eventset(&eventSet)) != PAPI_OK) {
// 		ERROR_RETURN(ret);
//     } else if ((ret=PAPI_add_events(eventSet, eventCodes, PAPI_COUNT)) !=
//     PAPI_OK) {
// 		ERROR_RETURN(ret);
//     } else if ((ret = PAPI_start(eventSet)) != PAPI_OK) {
//         ERROR_RETURN(ret);
