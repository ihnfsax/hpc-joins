...
public:
  ...
  static const uint64_t MEMORY_PARTITION_SIZE_BYTES =
      MEMORY_BUFFERS_PER_PARTITION * MEMORY_BUFFER_SIZE_BYTES;
  ...
  static const uint64_t NETWORK_PARTITIONING_COUNT =
      (1 << NETWORK_PARTITIONING_FANOUT);
  static const uint64_t LOCAL_PARTITIONING_COUNT =
      (1 << LOCAL_PARTITIONING_FANOUT);
